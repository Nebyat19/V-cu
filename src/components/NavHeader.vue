<template>
    <header class="flex items-center mb-5 justify-between">
       <div class="w-12  rounded-full h-12 relative">
        <router-link to="user/profile">   <img :src="AVATOR_MALE" class="absolute inset-0 w-full h-full overflow-hidden" alt=""></router-link>
       </div>
       <ul class="flex items-center justify-end gap-8">
        <li class="flex rounded-lg justify-between border border-gray-100 px-2 py-1">
            <input placeholder="search ..." class="text-xs placeholder:text-gray-400   text-gray-500 outline-none px-3 bg-inherit bg-opacity-0 w-32" type="text">
